...
**Type**: TXT  
**Name/Host**: `_dmarc`  
**Current Value**: `v=DMARC1; p=none; rua=mailto:contact@seoauditpro.net`  
**Recommended Value**: `v=DMARC1; p=quarantine; rua=mailto:contact@seoauditpro.net; ruf=mailto:contact@seoauditpro.net`
