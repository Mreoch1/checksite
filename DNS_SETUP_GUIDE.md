...
**Type**: TXT  
**Name/Host**: `_dmarc`  
**Current Value**: `v=DMARC1; p=none; rua=mailto:admin@seochecksite.net`  
**Recommended Value**: `v=DMARC1; p=quarantine; rua=mailto:admin@seochecksite.net; ruf=mailto:admin@seochecksite.net`
